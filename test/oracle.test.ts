...
contract('PloutozOracleContract', accounts => {
    // Rinkeby Addresses
    ...
    const ploutozOracleAddress = '0xD4C680B14994f385c15443a73600AC21aedEd18C';
    ...
    // const ploutozOracleAddress = '0x6e4c9A6843C4F14A2f6995746648CDec64B9B32d';
    ...
    // const ploutozOracleAddress = '0x7054e08461e3eCb7718B63540adDB3c3A1746415';

    let oracle: PloutozOracleInstance;
    before('set up contracts', async () => {
        oracle = await PloutozOracle.at(ploutozOracleAddress)
    });
