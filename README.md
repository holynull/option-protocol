...
```
Ploutoz Oracle: 0xD4C680B14994f385c15443a73600AC21aedEd18C
Ploutoz Factory: 0xcA7D654e09ea32C2fbC715339e74DbFC2c58cFD0
Ploutoz Exchange: 0xAF720c51e5100207852900a34C4DdFf8E056E0c7
...
```
? _symbol: string: oEthc call 400.00 2020/9/10
? _name: string: oEthc call 400.00 2020/9/10
? _underlyingType: string: USDC
? _strikeAsset: string: ETH
? _collateralType: string: ETH
? _strikePrice: uint256: 2500
? _strikePriceDecimals: uint8: 6
? _expiry: uint256: 1599719343
? _windowSize: uint256: 1598344440
```